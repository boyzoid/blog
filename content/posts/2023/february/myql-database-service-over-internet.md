...
![OCI Hamburger Menu](/assets/images/2023/mds-balancer/img1.png "OCI Hamburger Menu")
...
![VCN Search](/assets/images/2023/mds-balancer/img2.png "VCN Search")
...
![VCN Page](/assets/images/2023/mds-balancer/img3.png "VCN Page")
...
![VCN Subnets](/assets/images/2023/mds-balancer/img4.png "VCN Subnets")

Now, we need to select the Security List for the private subnet.

![Subnet Security List](/assets/images/2023/mds-balancer/img5.png "Subnet Security List")

Next, click the 'Add Ingress Rules' button.

![Ingress Rules](/assets/images/2023/mds-balancer/img6.png "Ingress Rules")
...
![Ingress Rules Form](/assets/images/2023/mds-balancer/img7.png "Ingress Rules Form")
...
![Public Ingress Rules Form](/assets/images/2023/mds-balancer/img8.png "Public Ingress Rules Form")
...
![MySQL Search](/assets/images/2023/mds-balancer/img9.png "MySQL Search")

On the next page, make sure you have selected the correct compartment.

![MySQL Choose Compartment](/assets/images/2023/mds-balancer/img10.png "MySQL Choose Compartment")

Now click the 'Create DB System' button with the proper compartment selected.

![MySQL Create DB System](/assets/images/2023/mds-balancer/img11.png "MySQL Create DB System")
...
![MySQL Create Form Part 1](/assets/images/2023/mds-balancer/img12.png "MySQL Create Form Part 1")
...
![MySQL Create Form Part 2](/assets/images/2023/mds-balancer/img13.png "MySQL Create Form Part 2")
...
![MySQL Create Form Part 3](/assets/images/2023/mds-balancer/img14.png "MySQL Create Form Part 3")
...
![MySQL Create Form Part 4](/assets/images/2023/mds-balancer/img15.png "MySQL Create Form Part 4")

We can accept the default values for the remainder of the form and click 'Create'.

![MySQL Create Form Submit](/assets/images/2023/mds-balancer/img16.png "MySQL Create Form Submit")
...
![Copy IP address](/assets/images/2023/mds-balancer/img17.png "Copy IP address")
...
![Load Balancer Search](/assets/images/2023/mds-balancer/img18.png "Load Balancer Search")

When on the Load Balancers page, we will click the 'Create Load Balancer' button.

![Load Balancer Create](/assets/images/2023/mds-balancer/img19.png "Load Balancer Create")

In the form that pops up, we want to:
1. Select 'Network Load Balancer'.
2. Click 'Create Load Balancer'.

![Load Balancer Form](/assets/images/2023/mds-balancer/img20.png "Load Balancer Form")
...
![Load Balancer Form Part 1](/assets/images/2023/mds-balancer/img21.png "Load Balancer Form Part 1" )
...
![Load Balancer Form Part 2](/assets/images/2023/mds-balancer/img22.png "Load Balancer Form Part 2")
...
![Load Balancer Part 4](/assets/images/2023/mds-balancer/img24.png "Load Balancer Part 4")
...
![Load Balancer Part 5](/assets/images/2023/mds-balancer/img25.png "Load Balancer Part 5")

### Review Details
In step 4, we want to review the details and click the 'Create network load balancer' button.

![Load Balancer Part 6](/assets/images/2023/mds-balancer/img26.png "Load Balancer Part 6")
...
![Load Balancer Creation Done](/assets/images/2023/mds-balancer/img27.png "Load Balancer Creation Done")
...
![Backend Sets Link](/assets/images/2023/mds-balancer/img28.png "Backend sets link")

On the backend sets page, click the link for the backend set we created earlier.

![Choose backend set](/assets/images/2023/mds-balancer/img29.png "Choose backend set")

When we get to the backend set details page, click the link named 'Backends' in the left column.

![Backend link](/assets/images/2023/mds-balancer/img30.png "Backend link")

Next, we click the 'Add Backends' button.

![Add backends button](/assets/images/2023/mds-balancer/img31.png "Add backends button")
...
![Configure Backend](/assets/images/2023/mds-balancer/img32.png "Configure Backend")
...
![Backend Set Health](/assets/images/2023/mds-balancer/img33.png "Backend Set Health")
...
![MySQL Shell connection port 3306](/assets/images/2023/mds-balancer/img34.png "MySQL Shell connection port 3306")
...
![MySQL Shell connection port 33060](/assets/images/2023/mds-balancer/img35.png "MySQL Shell connection port 33060")
