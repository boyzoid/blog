...
![VCN Wizard Step 4](/assets/images/2023/mds-openvpn/img-07.png "VCN Wizard Step 4")

Review the settings on the next screen and click the 'Create' button.

![VCN Wizard Step 5](/assets/images/2023/mds-openvpn/img-08.png "VCN Wizard Step 5")
...
![VCN Wizard Step 6](/assets/images/2023/mds-openvpn/img-10.png "VCN Wizard Step 6")
...
![VCN Private Subnet Link](/assets/images/2023/mds-openvpn/img-11.png "VCN Private Subnet Link")

On the details page for the private subnet, click the link to the default security list.

![VCN Private Subnet Security List](/assets/images/2023/mds-openvpn/img-12.png "VCN Private Subnet Security List")

Next, click the 'Add Ingress Rules' button.

![VCN Private Subnet Ingress Rules Button](/assets/images/2023/mds-openvpn/img-13.png "VCN Private Subnet Ingress Rules Button")
...
![VCN Private Subnet Ingress Rules](/assets/images/2023/mds-openvpn/img-14.png "VCN Private Subnet Ingress Rules")
...
![VCN Security List Link](/assets/images/2023/mds-openvpn/img-15.png "VCN Security List Link")
...
![VCN Security Public List Link](/assets/images/2023/mds-openvpn/img-16.png "VCN Security Public List Link")

Click the 'Add Ingress Rules' button.

![VCN Public Subnet Ingress Rules Button](/assets/images/2023/mds-openvpn/img-13.png "VCN Public Subnet Ingress Rules Button")
...
![VCN Public Subnet Ingress Rules](/assets/images/2023/mds-openvpn/img-17.png "VCN Public Subnet Ingress Rules")
...
![MySQL Link](/assets/images/2023/mds-openvpn/img-17_01.png "MySQL Link")

Click the 'Create DB System' button on the main page for 'DB Systems'.

![MySQL Create DB System Button](/assets/images/2023/mds-openvpn/img-17_02.png "MySQL Create DB System Button")
...
![Create MySQL Instance Part 1](/assets/images/2023/mds-openvpn/img-17_03.png "Create MySQL Instance Part 1")
...
![Create MySQL Instance Part 2](/assets/images/2023/mds-openvpn/img-17_04.png "Create MySQL Instance Part 2")
...
![Create MySQL Instance Part 3](/assets/images/2023/mds-openvpn/img-17_05.png "Create MySQL Instance Part 3")
...
![Create MySQL Instance Part 4](/assets/images/2023/mds-openvpn/img-17_06.png "Create MySQL Instance Part 4")
...
![Create MySQL Instance Part 5](/assets/images/2023/mds-openvpn/img-17_07.png "Create MySQL Instance Part 5")

We can accept the default values for the remaining sections and click the 'Create' button.

![Create MySQL Instance Part 6](/assets/images/2023/mds-openvpn/img-17_08.png "Create MySQL Instance Part 6")
...
![Create MySQL Instance Part 7](/assets/images/2023/mds-openvpn/img-17_09.png "Create MySQL Instance Part 7")
...
![OpenVPN Marketplace](/assets/images/2023/mds-openvpn/img-18.png "OpenVPN Marketplace")
...
![Create Compute Instance Step 1](/assets/images/2023/mds-openvpn/img-19.png "Create Compute Instance Step 1")
...
![Create Compute Instance Step 2](/assets/images/2023/mds-openvpn/img-20.png "Create Compute Instance Step 2")
...
![Create Compute Instance Step 3](/assets/images/2023/mds-openvpn/img-21.png "Create Compute Instance Step 3")
...
![Create Compute Instance Step 4](/assets/images/2023/mds-openvpn/img-22.png "Create Compute Instance Step 4")
...
![Create Compute Instance Step 5](/assets/images/2023/mds-openvpn/img-23.png "Create Compute Instance Step 5")

We can accept the default values for the remaining sections and click the 'Create' button.

![Create Compute Instance Step 6](/assets/images/2023/mds-openvpn/img-24.png "Create Compute Instance Step 6")
...
![Create Compute Instance Step 7](/assets/images/2023/mds-openvpn/img-25.png "Create Compute Instance Step 7")

In the 'Attached VNICs' section, click the three vertical dots on the right side (1) and then click 'Edit VNIC' (2).

![Attached VNIC Link](/assets/images/2023/mds-openvpn/img-26.png "Attached VNIC Link")

When the 'Edit VNIC' form opens, select the 'Skip source/destination check' checkbox (1) and click the 'Save changes' button.

![Edit VNIC](/assets/images/2023/mds-openvpn/img-27.png "Edit VNIC")
...
![Primary VNIC Information](/assets/images/2023/mds-openvpn/img-28.png "Primary VNIC Information")
...
![Route Tables Link](/assets/images/2023/mds-openvpn/img-29.png "Route Tables Link")

Click the link for the route table for the ***private*** subnet.

![Private Subnet Route Tables Link](/assets/images/2023/mds-openvpn/img-30.png "Private Subnet Route Tables Link")

Once on the Route Table page, we will click the 'Add Route Rules' button.

![Add Route Rules Button](/assets/images/2023/mds-openvpn/img-31.png "Add Route Rules Button")
...
![Add Route Rules Form](/assets/images/2023/mds-openvpn/img-32.png "Add Route Rules Form")
...
![OpenVPN Setup Part 1](/assets/images/2023/mds-openvpn/img-33.png "OpenVPN Setup Part 1")

Next, we specify this will be the 'primary Access Server' node by typing `yes` and pressing `enter`.

![OpenVPN Setup Part 2](/assets/images/2023/mds-openvpn/img-34.png "OpenVPN Setup Part 2")

We want the web UI to be used by all the network interfaces, so we type `1` and press `enter`.

![OpenVPN Setup Part 3](/assets/images/2023/mds-openvpn/img-35.png "OpenVPN Setup Part 3")

We can accept the default value for the algorithm to use for OpenVPN. For example, enter `rsa` and press `enter`.

![OpenVPN Setup Part 4](/assets/images/2023/mds-openvpn/img-36.png "OpenVPN Setup Part 4")

Specify the certificate's key size to be `2048` and press `enter`.

![OpenVPN Setup Part 5](/assets/images/2023/mds-openvpn/img-37.png "OpenVPN Setup Part 5")
...
![OpenVPN Setup Part 6](/assets/images/2023/mds-openvpn/img-38.png "OpenVPN Setup Part 6")

Specify the key size for the certificates to be `2048` and press `enter`.

![OpenVPN Setup Part 7](/assets/images/2023/mds-openvpn/img-39.png "OpenVPN Setup Part 7")
...
![OpenVPN Setup Part 8](/assets/images/2023/mds-openvpn/img-40.png "OpenVPN Setup Part 8")
...
![OpenVPN Setup Part 9](/assets/images/2023/mds-openvpn/img-41.png "OpenVPN Setup Part 9")

We want to have client traffic routed through the VPN by default, so we type `yes` and press `enter`.

![OpenVPN Setup Part 10](/assets/images/2023/mds-openvpn/img-42.png "OpenVPN Setup Part 10")

We need private subnets to be accessible to clients, so we type `yes` and press `enter`.

![OpenVPN Setup Part 11](/assets/images/2023/mds-openvpn/img-43.png "OpenVPN Setup Part 11")

We enable the option to log in to the web interface as 'openvpn' by typing `yes` and pressing `enter`.

![OpenVPN Setup Part 12](/assets/images/2023/mds-openvpn/img-44.png "OpenVPN Setup Part 12")

Next, we will enter the password and confirm the password for the 'openvpn' account.

![OpenVPN Setup Part 13](/assets/images/2023/mds-openvpn/img-45.png "OpenVPN Setup Part 13")

If we have an OpenVPN activation key, we can enter it or press `enter` to continue.

![OpenVPN Setup Part 14](/assets/images/2023/mds-openvpn/img-46.png "OpenVPN Setup Part 14")

The server will go through the process of setting up the server. When it is complete, we will see something like this:

![OpenVPN Setup Part 15](/assets/images/2023/mds-openvpn/img-47.png "OpenVPN Setup Part 15")
...
![OpenVPN Web UI Part 1](/assets/images/2023/mds-openvpn/img-48.png "OpenVPN Web UI Part 1")

We then click the 'Continue to....' link.

![OpenVPN Web UI Part 2](/assets/images/2023/mds-openvpn/img-49.png "OpenVPN Web UI Part 2")
...
![OpenVPN Web UI Part 3](/assets/images/2023/mds-openvpn/img-50.png "OpenVPN Web UI Part 3")
...
![OpenVPN Web UI Part 4](/assets/images/2023/mds-openvpn/img-51.png "OpenVPN Web UI Part 4")
...
![OpenVPN Web UI Part 5](/assets/images/2023/mds-openvpn/img-52.png "OpenVPN Web UI Part 5")

Scroll to the bottom of the page and click 'Save Settings'.

![OpenVPN Web UI Part 6](/assets/images/2023/mds-openvpn/img-53.png "OpenVPN Web UI Part 6")
...
![OpenVPN Web UI Part 7](/assets/images/2023/mds-openvpn/img-54.png "OpenVPN Web UI Part 7")

In the left sidebar, click the 'VPN Settings' link under 'Configuration'.

![OpenVPN Web UI Part 8](/assets/images/2023/mds-openvpn/img-55.png "OpenVPN Web UI Part 8")
...
![OpenVPN Web UI Part 9](/assets/images/2023/mds-openvpn/img-56.png "OpenVPN Web UI Part 9")
...
![OpenVPN Web UI Part 10](/assets/images/2023/mds-openvpn/img-57.png "OpenVPN Web UI Part 10")
...
![OpenVPN Web UI Part 11](/assets/images/2023/mds-openvpn/img-58.png "OpenVPN Web UI Part 11")

Scroll to the bottom of the page and click 'Save Settings'.
When the settings are saved, make sure to update the running server.

![OpenVPN Web UI Part 12](/assets/images/2023/mds-openvpn/img-59.png "OpenVPN Web UI Part 12")

In the left sidebar, click the 'User Permissions' link under 'User Management'.

![OpenVPN Web UI Part 13](/assets/images/2023/mds-openvpn/img-60.png "OpenVPN Web UI Part 13")
...
![OpenVPN Web UI Part 14](/assets/images/2023/mds-openvpn/img-61.png "OpenVPN Web UI Part 14")
...
![OpenVPN Client Part 1](/assets/images/2023/mds-openvpn/img-62.png "OpenVPN Client Part 1")
...
![OpenVPN Client Part 2](/assets/images/2023/mds-openvpn/img-63.png "OpenVPN Client Part 2")

We may see a pop-up window similar to the one below. We want to click 'Accept'.

![OpenVPN Client Part 3](/assets/images/2023/mds-openvpn/img-64.png "OpenVPN Client Part 3")
...
![OpenVPN Client Part 4](/assets/images/2023/mds-openvpn/img-65.png "OpenVPN Client Part 4")

After a short while, we will be connected to the VPN. At that time, we will see something similar to this image:

![OpenVPN Client Part 5](/assets/images/2023/mds-openvpn/img-66.png "OpenVPN Client Part 5")
...
![Connected to the database](/assets/images/2023/mds-openvpn/img-67.png "Connected to the database")
