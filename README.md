...
You can check out the live version on [https://eleventy-chirpy-blog-template.netlify.app](https://eleventy-chirpy-blog-template.netlify.app).
...
Open the page, usually on [http://localhost:8080](http://localhost:8080), and dig around!
